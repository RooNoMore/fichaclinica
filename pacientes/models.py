...
class Epicrisis(models.Model):
    ...
    examenes_pendientes = models.BooleanField(default=False)
    detalle_examenes_pendientes = models.TextField(blank=True)
    examenes_realizados = models.BooleanField(default=False)
    detalle_examenes_realizados = models.TextField(blank=True)
    condicion_mejorado = models.BooleanField(default=True)
